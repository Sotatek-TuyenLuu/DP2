...
execute_process(
  ...
  WORKING_DIRECTORY "D:/p/MyProject-build/MITK"
...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref releases/2016-03
  WORKING_DIRECTORY "D:/p/MyProject-build/MITK"
...
if("${show_ref_output}" MATCHES "refs/remotes/releases/2016-03")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "releases/2016-03")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "releases/2016-03")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 releases/2016-03
  WORKING_DIRECTORY "D:/p/MyProject-build/MITK"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'http://git.mitk.org/MITK.git'")
  endif()
    ...
    # if(error_code)
      ...
      # if(need_stash)
        # execute_process(
          ...
          # )
      # endif()
      # message(FATAL_ERROR "\nFailed to rebase in: 'D:/p/MyProject-build/MITK/'.\nYou will have to resolve the conflicts manually")
    # endif()
      ...
      # if(error_code)
        ...
        # if(error_code)
          ...
          # execute_process(
            ...
            # WORKING_DIRECTORY "D:/p/MyProject-build/MITK"
          # )
          # message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/p/MyProject-build/MITK/'.\nYou will have to resolve the conflicts manually")
        # endif()
      # endif()
    # endif()
  else()
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to update submodules in: 'D:/p/MyProject-build/MITK/'")
  endif()
endif()
