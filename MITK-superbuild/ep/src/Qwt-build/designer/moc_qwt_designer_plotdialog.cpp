...
#include "../../Qwt/designer/qwt_designer_plotdialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__PlotDialog_t, stringdata) + ofs \
...
void *QwtDesignerPlugin::PlotDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QwtDesignerPlugin__PlotDialog.stringdata))
