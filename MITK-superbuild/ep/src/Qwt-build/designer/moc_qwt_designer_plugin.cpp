...
#include "../../Qwt/designer/qwt_designer_plugin.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__CustomWidgetInterface_t, stringdata) + ofs \
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__CustomWidgetCollectionInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__PlotInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__PlotCanvasInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__AnalogClockInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__CompassInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__CounterInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__DialInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__KnobInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__ScaleWidgetInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__SliderInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__TextLabelInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__ThermoInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__WheelInterface_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__TaskMenuFactory_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtDesignerPlugin__TaskMenuExtension_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
