...
struct qt_meta_stringdata_vtkQtTreeView_t {
    QByteArrayData data[7];
    char stringdata[92];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtTreeView_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_vtkQtTreeView_t qt_meta_stringdata_vtkQtTreeView = {
    {
QT_MOC_LITERAL(0, 0, 13), // "vtkQtTreeView"
QT_MOC_LITERAL(1, 14, 8), // "expanded"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 9), // "collapsed"
QT_MOC_LITERAL(4, 34, 19), // "updatePreviewWidget"
QT_MOC_LITERAL(5, 54, 22), // "slotQtSelectionChanged"
QT_MOC_LITERAL(6, 77, 14) // "QItemSelection"

    },
    "vtkQtTreeView\0expanded\0\0collapsed\0"
    "updatePreviewWidget\0slotQtSelectionChanged\0"
    "QItemSelection"
};
...
void vtkQtTreeView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (vtkQtTreeView::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&vtkQtTreeView::expanded)) {
                *result = 0;
            }
        }
        {
            typedef void (vtkQtTreeView::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&vtkQtTreeView::collapsed)) {
                *result = 1;
            }
        }
        {
            typedef void (vtkQtTreeView::*_t)(const QModelIndex & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&vtkQtTreeView::updatePreviewWidget)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject vtkQtTreeView::staticMetaObject = {
    { &vtkQtView::staticMetaObject, qt_meta_stringdata_vtkQtTreeView.data,
      qt_meta_data_vtkQtTreeView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *vtkQtTreeView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtTreeView.stringdata))
