...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtTableModelAdapter_t, stringdata) + ofs \
...
void vtkQtTableModelAdapter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&vtkQtTableModelAdapter::selectionDropped)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject vtkQtTableModelAdapter::staticMetaObject = {
    { &vtkQtAbstractModelAdapter::staticMetaObject, qt_meta_stringdata_vtkQtTableModelAdapter.data,
      qt_meta_data_vtkQtTableModelAdapter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *vtkQtTableModelAdapter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtTableModelAdapter.stringdata))
