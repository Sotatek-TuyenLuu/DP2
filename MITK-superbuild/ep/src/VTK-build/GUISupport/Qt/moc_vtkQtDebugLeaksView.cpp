...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtDebugLeaksView_t, stringdata) + ofs \
...
const QMetaObject vtkQtDebugLeaksView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_vtkQtDebugLeaksView.data,
      qt_meta_data_vtkQtDebugLeaksView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *vtkQtDebugLeaksView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtDebugLeaksView.stringdata))
