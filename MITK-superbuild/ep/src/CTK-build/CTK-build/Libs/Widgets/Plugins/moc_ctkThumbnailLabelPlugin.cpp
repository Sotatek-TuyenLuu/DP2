...
#include "../../../../../CTK/Libs/Widgets/Plugins/ctkThumbnailLabelPlugin.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkThumbnailLabelPlugin_t, stringdata) + ofs \
...
const QMetaObject ctkThumbnailLabelPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ctkThumbnailLabelPlugin.data,
      qt_meta_data_ctkThumbnailLabelPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkThumbnailLabelPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkThumbnailLabelPlugin.stringdata))
        return static_cast<void*>(const_cast< ctkThumbnailLabelPlugin*>(this));
    if (!strcmp(_clname, "ctkWidgetsAbstractPlugin"))
        return static_cast< ctkWidgetsAbstractPlugin*>(const_cast< ctkThumbnailLabelPlugin*>(this));
