...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkProxyStyle_t, stringdata) + ofs \
...
const QMetaObject ctkProxyStyle::staticMetaObject = {
    { &QProxyStyle::staticMetaObject, qt_meta_stringdata_ctkProxyStyle.data,
      qt_meta_data_ctkProxyStyle,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkProxyStyle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkProxyStyle.stringdata))
        return static_cast<void*>(const_cast< ctkProxyStyle*>(this));
