...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkPathListButtonsWidgetPrivate_t, stringdata) + ofs \
...
void ctkPathListButtonsWidgetPrivate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkPathListButtonsWidgetPrivate *_t = static_cast<ctkPathListButtonsWidgetPrivate *>(_o);
        switch (_id) {
...
const QMetaObject ctkPathListButtonsWidgetPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ctkPathListButtonsWidgetPrivate.data,
      qt_meta_data_ctkPathListButtonsWidgetPrivate,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkPathListButtonsWidgetPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkPathListButtonsWidgetPrivate.stringdata))
        return static_cast<void*>(const_cast< ctkPathListButtonsWidgetPrivate*>(this));
    if (!strcmp(_clname, "Ui_ctkPathListButtonsWidget"))
        return static_cast< Ui_ctkPathListButtonsWidget*>(const_cast< ctkPathListButtonsWidgetPrivate*>(this));
