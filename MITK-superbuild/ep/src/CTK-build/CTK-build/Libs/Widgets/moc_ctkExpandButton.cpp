...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkExpandButton_t, stringdata) + ofs \
...
const QMetaObject ctkExpandButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_ctkExpandButton.data,
      qt_meta_data_ctkExpandButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkExpandButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkExpandButton.stringdata))
        return static_cast<void*>(const_cast< ctkExpandButton*>(this));
...
int ctkExpandButton::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< bool*>(_v) = mirrorOnExpand(); break;
        default: break;
        }
        _id -= 2;
        ...
        case 1: setMirrorOnExpand(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
        _id -= 2;
