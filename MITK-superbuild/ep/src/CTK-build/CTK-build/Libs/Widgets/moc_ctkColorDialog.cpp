...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkColorDialog_t, stringdata) + ofs \
...
void ctkColorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkColorDialog *_t = static_cast<ctkColorDialog *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkColorDialog::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkColorDialog::currentColorNameChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ctkColorDialog::staticMetaObject = {
    { &QColorDialog::staticMetaObject, qt_meta_stringdata_ctkColorDialog.data,
      qt_meta_data_ctkColorDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkColorDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkColorDialog.stringdata))
        return static_cast<void*>(const_cast< ctkColorDialog*>(this));
