...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkModalityWidget_t, stringdata) + ofs \
...
void ctkModalityWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkModalityWidget *_t = static_cast<ctkModalityWidget *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkModalityWidget::*_t)(const QStringList );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkModalityWidget::selectedModalitiesChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ctkModalityWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ctkModalityWidget.data,
      qt_meta_data_ctkModalityWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkModalityWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkModalityWidget.stringdata))
        return static_cast<void*>(const_cast< ctkModalityWidget*>(this));
...
int ctkModalityWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QStringList*>(_v) = selectedModalities(); break;
        case 1: *reinterpret_cast< QStringList*>(_v) = visibleModalities(); break;
        default: break;
        }
        _id -= 2;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: setSelectedModalities(*reinterpret_cast< QStringList*>(_v)); break;
        case 1: setVisibleModalities(*reinterpret_cast< QStringList*>(_v)); break;
        default: break;
        }
        _id -= 2;
