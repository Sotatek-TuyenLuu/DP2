...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkDoubleSlider_t, stringdata) + ofs \
...
void ctkDoubleSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkDoubleSlider *_t = static_cast<ctkDoubleSlider *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkDoubleSlider::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkDoubleSlider::valueChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (ctkDoubleSlider::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkDoubleSlider::sliderMoved)) {
                *result = 1;
            }
        }
        {
            typedef void (ctkDoubleSlider::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkDoubleSlider::sliderPressed)) {
                *result = 2;
            }
        }
        {
            typedef void (ctkDoubleSlider::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkDoubleSlider::sliderReleased)) {
                *result = 3;
            }
        }
        {
            typedef void (ctkDoubleSlider::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkDoubleSlider::rangeChanged)) {
                *result = 4;
            }
        }
    }
...
const QMetaObject ctkDoubleSlider::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ctkDoubleSlider.data,
      qt_meta_data_ctkDoubleSlider,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkDoubleSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkDoubleSlider.stringdata))
        return static_cast<void*>(const_cast< ctkDoubleSlider*>(this));
...
int ctkDoubleSlider::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< double*>(_v) = sliderPosition(); break;
        case 2: *reinterpret_cast< double*>(_v) = singleStep(); break;
        case 3: *reinterpret_cast< double*>(_v) = pageStep(); break;
        case 4: *reinterpret_cast< double*>(_v) = minimum(); break;
        case 5: *reinterpret_cast< double*>(_v) = maximum(); break;
        case 6: *reinterpret_cast< double*>(_v) = tickInterval(); break;
        case 7: *reinterpret_cast< QSlider::TickPosition*>(_v) = tickPosition(); break;
        case 8: *reinterpret_cast< bool*>(_v) = hasTracking(); break;
        case 9: *reinterpret_cast< Qt::Orientation*>(_v) = orientation(); break;
        case 10: *reinterpret_cast< QString*>(_v) = handleToolTip(); break;
        case 11: *reinterpret_cast< bool*>(_v) = invertedAppearance(); break;
        ...
        case 1: setSliderPosition(*reinterpret_cast< double*>(_v)); break;
        case 2: setSingleStep(*reinterpret_cast< double*>(_v)); break;
        case 3: setPageStep(*reinterpret_cast< double*>(_v)); break;
        case 4: setMinimum(*reinterpret_cast< double*>(_v)); break;
        case 5: setMaximum(*reinterpret_cast< double*>(_v)); break;
        case 6: setTickInterval(*reinterpret_cast< double*>(_v)); break;
        case 7: setTickPosition(*reinterpret_cast< QSlider::TickPosition*>(_v)); break;
        case 8: setTracking(*reinterpret_cast< bool*>(_v)); break;
        case 9: setOrientation(*reinterpret_cast< Qt::Orientation*>(_v)); break;
        case 10: setHandleToolTip(*reinterpret_cast< QString*>(_v)); break;
        case 11: setInvertedAppearance(*reinterpret_cast< bool*>(_v)); break;
