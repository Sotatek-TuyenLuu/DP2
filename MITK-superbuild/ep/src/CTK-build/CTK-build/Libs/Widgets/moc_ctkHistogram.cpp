...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkHistogram_t, stringdata) + ofs \
...
const QMetaObject ctkHistogram::staticMetaObject = {
    { &ctkTransferFunction::staticMetaObject, qt_meta_stringdata_ctkHistogram.data,
      qt_meta_data_ctkHistogram,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkHistogram::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkHistogram.stringdata))
        return static_cast<void*>(const_cast< ctkHistogram*>(this));
