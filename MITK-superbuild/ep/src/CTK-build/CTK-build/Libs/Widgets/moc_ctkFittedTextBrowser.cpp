...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkFittedTextBrowser_t, stringdata) + ofs \
...
QT_MOC_LITERAL(1, 21, 28), // "heightForWidthMayHaveChanged"
QT_MOC_LITERAL(2, 50, 0) // ""

    },
    "ctkFittedTextBrowser\0heightForWidthMayHaveChanged\0"
    ""
};
...
void ctkFittedTextBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkFittedTextBrowser *_t = static_cast<ctkFittedTextBrowser *>(_o);
        switch (_id) {
        case 0: _t->heightForWidthMayHaveChanged(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ctkFittedTextBrowser::staticMetaObject = {
    { &QTextBrowser::staticMetaObject, qt_meta_stringdata_ctkFittedTextBrowser.data,
      qt_meta_data_ctkFittedTextBrowser,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkFittedTextBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkFittedTextBrowser.stringdata))
        return static_cast<void*>(const_cast< ctkFittedTextBrowser*>(this));
