...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkTransferFunctionItem_t, stringdata) + ofs \
...
void ctkTransferFunctionItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkTransferFunctionItem *_t = static_cast<ctkTransferFunctionItem *>(_o);
        switch (_id) {
...
const QMetaObject ctkTransferFunctionItem::staticMetaObject = {
    { &QGraphicsObject::staticMetaObject, qt_meta_stringdata_ctkTransferFunctionItem.data,
      qt_meta_data_ctkTransferFunctionItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkTransferFunctionItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkTransferFunctionItem.stringdata))
        return static_cast<void*>(const_cast< ctkTransferFunctionItem*>(this));
