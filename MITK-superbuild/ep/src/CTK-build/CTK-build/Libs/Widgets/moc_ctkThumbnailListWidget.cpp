...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkThumbnailListWidget_t, stringdata) + ofs \
...
void ctkThumbnailListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkThumbnailListWidget *_t = static_cast<ctkThumbnailListWidget *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkThumbnailListWidget::*_t)(const ctkThumbnailLabel & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkThumbnailListWidget::selected)) {
                *result = 0;
            }
        }
        {
            typedef void (ctkThumbnailListWidget::*_t)(const ctkThumbnailLabel & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkThumbnailListWidget::doubleClicked)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ctkThumbnailListWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ctkThumbnailListWidget.data,
      qt_meta_data_ctkThumbnailListWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkThumbnailListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkThumbnailListWidget.stringdata))
        return static_cast<void*>(const_cast< ctkThumbnailListWidget*>(this));
...
int ctkThumbnailListWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< int*>(_v) = currentThumbnail(); break;
        case 1: *reinterpret_cast< Qt::Orientation*>(_v) = flow(); break;
        case 2: *reinterpret_cast< QSize*>(_v) = thumbnailSize(); break;
        default: break;
        }
        _id -= 3;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: setCurrentThumbnail(*reinterpret_cast< int*>(_v)); break;
        case 1: setFlow(*reinterpret_cast< Qt::Orientation*>(_v)); break;
        case 2: setThumbnailSize(*reinterpret_cast< QSize*>(_v)); break;
        default: break;
        }
        _id -= 3;
