...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkColorPickerButton_t, stringdata) + ofs \
...
void ctkColorPickerButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkColorPickerButton *_t = static_cast<ctkColorPickerButton *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkColorPickerButton::*_t)(QColor );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkColorPickerButton::colorChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (ctkColorPickerButton::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkColorPickerButton::colorNameChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ctkColorPickerButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_ctkColorPickerButton.data,
      qt_meta_data_ctkColorPickerButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkColorPickerButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkColorPickerButton.stringdata))
        return static_cast<void*>(const_cast< ctkColorPickerButton*>(this));
...
int ctkColorPickerButton::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< QString*>(_v) = colorName(); break;
        case 2: *reinterpret_cast< bool*>(_v) = displayColorName(); break;
        case 3: *reinterpret_cast<int*>(_v) = QFlag(dialogOptions()); break;
        default: break;
        }
        _id -= 4;
        ...
        case 1: setColorName(*reinterpret_cast< QString*>(_v)); break;
        case 2: setDisplayColorName(*reinterpret_cast< bool*>(_v)); break;
        case 3: setDialogOptions(QFlag(*reinterpret_cast<int*>(_v))); break;
        default: break;
        }
        _id -= 4;
