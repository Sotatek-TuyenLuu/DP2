...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkMaterialPropertyPreviewLabel_t, stringdata) + ofs \
...
void ctkMaterialPropertyPreviewLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkMaterialPropertyPreviewLabel *_t = static_cast<ctkMaterialPropertyPreviewLabel *>(_o);
        switch (_id) {
...
const QMetaObject ctkMaterialPropertyPreviewLabel::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ctkMaterialPropertyPreviewLabel.data,
      qt_meta_data_ctkMaterialPropertyPreviewLabel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkMaterialPropertyPreviewLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkMaterialPropertyPreviewLabel.stringdata))
        return static_cast<void*>(const_cast< ctkMaterialPropertyPreviewLabel*>(this));
...
int ctkMaterialPropertyPreviewLabel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< double*>(_v) = ambient(); break;
        case 1: *reinterpret_cast< double*>(_v) = diffuse(); break;
        case 2: *reinterpret_cast< double*>(_v) = specular(); break;
        case 3: *reinterpret_cast< double*>(_v) = specularPower(); break;
        case 4: *reinterpret_cast< QColor*>(_v) = color(); break;
        case 5: *reinterpret_cast< double*>(_v) = opacity(); break;
        case 6: *reinterpret_cast< double*>(_v) = gridOpacity(); break;
        default: break;
        }
        _id -= 7;
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: setAmbient(*reinterpret_cast< double*>(_v)); break;
        case 1: setDiffuse(*reinterpret_cast< double*>(_v)); break;
        case 2: setSpecular(*reinterpret_cast< double*>(_v)); break;
        case 3: setSpecularPower(*reinterpret_cast< double*>(_v)); break;
        case 4: setColor(*reinterpret_cast< QColor*>(_v)); break;
        case 5: setOpacity(*reinterpret_cast< double*>(_v)); break;
        case 6: setGridOpacity(*reinterpret_cast< double*>(_v)); break;
        default: break;
        }
        _id -= 7;
