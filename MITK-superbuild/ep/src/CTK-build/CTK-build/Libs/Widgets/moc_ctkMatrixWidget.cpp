...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkMatrixWidget_t, stringdata) + ofs \
...
void ctkMatrixWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkMatrixWidget *_t = static_cast<ctkMatrixWidget *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkMatrixWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkMatrixWidget::matrixChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (ctkMatrixWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkMatrixWidget::decimalsChanged)) {
                *result = 1;
            }
        }
...
static const QMetaObject * const qt_meta_extradata_ctkMatrixWidget[] = {
        &ctkDoubleSpinBox::staticMetaObject,
    Q_NULLPTR
};

const QMetaObject ctkMatrixWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ctkMatrixWidget.data,
      qt_meta_data_ctkMatrixWidget,  qt_static_metacall, qt_meta_extradata_ctkMatrixWidget, Q_NULLPTR}
};
...
void *ctkMatrixWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkMatrixWidget.stringdata))
        return static_cast<void*>(const_cast< ctkMatrixWidget*>(this));
...
int ctkMatrixWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: *reinterpret_cast< int*>(_v) = rowCount(); break;
        case 2: *reinterpret_cast< bool*>(_v) = isEditable(); break;
        ...
        case 6: *reinterpret_cast< ctkDoubleSpinBox::DecimalsOptions*>(_v) = decimalsOption(); break;
        case 7: *reinterpret_cast< double*>(_v) = singleStep(); break;
        case 8: *reinterpret_cast< QVector<double>*>(_v) = values(); break;
        default: break;
        }
        _id -= 9;
        ...
        case 1: setRowCount(*reinterpret_cast< int*>(_v)); break;
        case 2: setEditable(*reinterpret_cast< bool*>(_v)); break;
        ...
        case 6: setDecimalsOption(*reinterpret_cast< ctkDoubleSpinBox::DecimalsOptions*>(_v)); break;
        case 7: setSingleStep(*reinterpret_cast< double*>(_v)); break;
        case 8: setValues(*reinterpret_cast< QVector<double>*>(_v)); break;
        default: break;
        }
        _id -= 9;
