...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkPluginFrameworkDebugOptions_t, stringdata) + ofs \
...
const QMetaObject ctkPluginFrameworkDebugOptions::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ctkPluginFrameworkDebugOptions.data,
      qt_meta_data_ctkPluginFrameworkDebugOptions,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkPluginFrameworkDebugOptions::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkPluginFrameworkDebugOptions.stringdata))
        return static_cast<void*>(const_cast< ctkPluginFrameworkDebugOptions*>(this));
    if (!strcmp(_clname, "ctkDebugOptions"))
        return static_cast< ctkDebugOptions*>(const_cast< ctkPluginFrameworkDebugOptions*>(this));
