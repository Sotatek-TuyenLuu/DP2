...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkErrorLogQtMessageHandler_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ctkErrorLogQtMessageHandler_t qt_meta_stringdata_ctkErrorLogQtMessageHandler = {
    {
QT_MOC_LITERAL(0, 0, 27) // "ctkErrorLogQtMessageHandler"
...
const QMetaObject ctkErrorLogQtMessageHandler::staticMetaObject = {
    { &ctkErrorLogAbstractMessageHandler::staticMetaObject, qt_meta_stringdata_ctkErrorLogQtMessageHandler.data,
      qt_meta_data_ctkErrorLogQtMessageHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkErrorLogQtMessageHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkErrorLogQtMessageHandler.stringdata))
        return static_cast<void*>(const_cast< ctkErrorLogQtMessageHandler*>(this));
