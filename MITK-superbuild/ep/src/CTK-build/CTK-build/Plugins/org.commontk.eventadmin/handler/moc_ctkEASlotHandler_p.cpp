...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ctkEASlotHandler_t, stringdata) + ofs \
...
void ctkEASlotHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ctkEASlotHandler *_t = static_cast<ctkEASlotHandler *>(_o);
        switch (_id) {
        ...
        {
            typedef void (ctkEASlotHandler::*_t)(const ctkEvent & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ctkEASlotHandler::eventOccured)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject ctkEASlotHandler::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ctkEASlotHandler.data,
      qt_meta_data_ctkEASlotHandler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ctkEASlotHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ctkEASlotHandler.stringdata))
        return static_cast<void*>(const_cast< ctkEASlotHandler*>(this));
    if (!strcmp(_clname, "ctkEventHandler"))
        return static_cast< ctkEventHandler*>(const_cast< ctkEASlotHandler*>(this));
