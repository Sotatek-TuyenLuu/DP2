...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata__LogListener_t, stringdata) + ofs \
...
const QMetaObject _LogListener::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata__LogListener.data,
      qt_meta_data__LogListener,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *_LogListener::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata__LogListener.stringdata))
        return static_cast<void*>(const_cast< _LogListener*>(this));
    if (!strcmp(_clname, "ctkLogListener"))
        return static_cast< ctkLogListener*>(const_cast< _LogListener*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ctkEALogEventAdapter_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject ctkEALogEventAdapter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ctkEALogEventAdapter.data,
      qt_meta_data_ctkEALogEventAdapter,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_ctkEALogEventAdapter.stringdata))
        return static_cast<void*>(const_cast< ctkEALogEventAdapter*>(this));
    if (!strcmp(_clname, "ctkEAAbstractAdapter"))
        return static_cast< ctkEAAbstractAdapter*>(const_cast< ctkEALogEventAdapter*>(this));
    return QObject::qt_metacast(_clname);
}
