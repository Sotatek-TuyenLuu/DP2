...
/* #undef US_GCC_RTTI_WORKAROUND_NEEDED */
/* #undef US_HAVE_VISIBILITY_ATTRIBUTE */

//-------------------------------------------------------------------
// Header Availability
//-------------------------------------------------------------------

/* #undef US_HAVE_CXXABI_H */
#define US_HAVE_STDINT_H
/* #undef US_HAVE_TR1_UNORDERED_MAP_H */
/* #undef US_HAVE_TR1_UNORDERED_SET_H */
/* #undef US_HAVE_TR1_FUNCTIONAL_H */
#define US_HAVE_UNORDERED_MAP_H
#define US_HAVE_UNORDERED_SET_H
#define US_HAVE_FUNCTIONAL_H

#define US_HAVE_TR1_UNORDERED_MAP
#define US_HAVE_TR1_UNORDERED_SET
#define US_HAVE_TR1_FUNCTION
#define US_HAVE_STD_UNORDERED_MAP
#define US_HAVE_STD_UNORDERED_SET
#define US_HAVE_STD_FUNCTION

#define US_HAVE_TR1_HASH
/* #undef US_HAVE_TR1_HASH_STRUCT */
/* #undef US_HAVE_TR1_HASH_CLASS */
#define US_HAVE_STD_HASH
#define US_HAVE_STD_HASH_STRUCT
/* #undef US_HAVE_STD_HASH_CLASS */

///-------------------------------------------------------------------
// Version information
//-------------------------------------------------------------------

#define CppMicroServices_MAJOR_VERSION 2
#define CppMicroServices_MINOR_VERSION 99
#define CppMicroServices_PATCH_VERSION 0
#define CppMicroServices_VERSION 2.99.0
#define CppMicroServices_VERSION_STR "2.99.0"

#define US_MAJOR_VERSION 2
#define US_MINOR_VERSION 99
#define US_PATCH_VERSION 0
#define US_VERSION 2.99.0
#define US_VERSION_STR "2.99.0"
