...
#include "../../../../MITK/Modules/OpenViewCore/QVTKInteractorInternal.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QVTKInteractorInternal_t, stringdata) + ofs \
...
const QMetaObject QVTKInteractorInternal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QVTKInteractorInternal.data,
      qt_meta_data_QVTKInteractorInternal,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QVTKInteractorInternal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QVTKInteractorInternal.stringdata))
