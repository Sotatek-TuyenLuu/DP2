...
#include "../../../../MITK/Modules/OpenViewCore/vtkQtConnection.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_vtkQtConnection_t, stringdata) + ofs \
...
void *vtkQtConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_vtkQtConnection.stringdata))
