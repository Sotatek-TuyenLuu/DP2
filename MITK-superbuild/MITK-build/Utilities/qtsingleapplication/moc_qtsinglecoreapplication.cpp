...
#include "../../../../MITK/Utilities/qtsingleapplication/qtsinglecoreapplication.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtSingleCoreApplication_t, stringdata) + ofs \
...
void QtSingleCoreApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->sendMessage((*reinterpret_cast< const QByteArray(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
        ...
        {
            typedef void (QtSingleCoreApplication::*_t)(const QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QtSingleCoreApplication::messageReceived)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QtSingleCoreApplication::staticMetaObject = {
    { &QCoreApplication::staticMetaObject, qt_meta_stringdata_QtSingleCoreApplication.data,
      qt_meta_data_QtSingleCoreApplication,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtSingleCoreApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtSingleCoreApplication.stringdata))
