...
#include "../../../../MITK/Utilities/qtsingleapplication/qtlocalpeer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtLocalPeer_t, stringdata) + ofs \
...
void QtLocalPeer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QtLocalPeer::*_t)(const QByteArray & );
...
const QMetaObject QtLocalPeer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QtLocalPeer.data,
      qt_meta_data_QtLocalPeer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QtLocalPeer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtLocalPeer.stringdata))
...
// SIGNAL 0
void QtLocalPeer::messageReceived(const QByteArray & _t1)
{
