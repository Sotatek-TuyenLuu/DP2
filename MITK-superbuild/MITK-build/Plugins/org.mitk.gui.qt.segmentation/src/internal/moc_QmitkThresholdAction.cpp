/****************************************************************************
** Meta object code from reading C++ file 'QmitkThresholdAction.h'
**
...
#error "The header file 'QmitkThresholdAction.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QmitkThresholdAction_t, stringdata) + ofs \
...
const QMetaObject QmitkThresholdAction::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QmitkThresholdAction.data,
      qt_meta_data_QmitkThresholdAction,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QmitkThresholdAction::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QmitkThresholdAction.stringdata))
        return static_cast<void*>(const_cast< QmitkThresholdAction*>(this));
    if (!strcmp(_clname, "mitk::IContextMenuAction"))
        return static_cast< mitk::IContextMenuAction*>(const_cast< QmitkThresholdAction*>(this));
