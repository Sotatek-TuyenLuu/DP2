/****************************************************************************
** Meta object code from reading C++ file 'QmitkDataSelectionWidget.h'
**
...
#include "src/internal/Common/QmitkDataSelectionWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'QmitkDataSelectionWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QmitkDataSelectionWidget_t, stringdata) + ofs \
...
void QmitkDataSelectionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QmitkDataSelectionWidget::*_t)(unsigned int , const mitk::DataNode * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QmitkDataSelectionWidget::SelectionChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QmitkDataSelectionWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QmitkDataSelectionWidget.data,
      qt_meta_data_QmitkDataSelectionWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QmitkDataSelectionWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QmitkDataSelectionWidget.stringdata))
        return static_cast<void*>(const_cast< QmitkDataSelectionWidget*>(this));
