/****************************************************************************
** Meta object code from reading C++ file 'QmitkSegmentationUtilitiesView.h'
**
...
#include "src/internal/SegmentationUtilities/QmitkSegmentationUtilitiesView.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'QmitkSegmentationUtilitiesView.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QmitkSegmentationUtilitiesView_t, stringdata) + ofs \
...
const QMetaObject QmitkSegmentationUtilitiesView::staticMetaObject = {
    { &QmitkAbstractView::staticMetaObject, qt_meta_stringdata_QmitkSegmentationUtilitiesView.data,
      qt_meta_data_QmitkSegmentationUtilitiesView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QmitkSegmentationUtilitiesView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QmitkSegmentationUtilitiesView.stringdata))
        return static_cast<void*>(const_cast< QmitkSegmentationUtilitiesView*>(this));
    if (!strcmp(_clname, "mitk::IRenderWindowPartListener"))
        return static_cast< mitk::IRenderWindowPartListener*>(const_cast< QmitkSegmentationUtilitiesView*>(this));
