/****************************************************************************
** Meta object code from reading C++ file 'QmitkSurfaceToImageWidget.h'
**
...
#include "src/internal/SegmentationUtilities/SurfaceToImage/QmitkSurfaceToImageWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'QmitkSurfaceToImageWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QmitkSurfaceToImageWidget_t, stringdata) + ofs \
...
const QMetaObject QmitkSurfaceToImageWidget::staticMetaObject = {
    { &QmitkSegmentationUtilityWidget::staticMetaObject, qt_meta_stringdata_QmitkSurfaceToImageWidget.data,
      qt_meta_data_QmitkSurfaceToImageWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QmitkSurfaceToImageWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QmitkSurfaceToImageWidget.stringdata))
        return static_cast<void*>(const_cast< QmitkSurfaceToImageWidget*>(this));
