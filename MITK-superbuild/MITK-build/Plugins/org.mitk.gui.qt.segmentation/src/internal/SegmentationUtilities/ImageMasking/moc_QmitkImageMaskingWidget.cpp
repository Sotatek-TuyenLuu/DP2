/****************************************************************************
** Meta object code from reading C++ file 'QmitkImageMaskingWidget.h'
**
...
#include "src/internal/SegmentationUtilities/ImageMasking/QmitkImageMaskingWidget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'QmitkImageMaskingWidget.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QmitkImageMaskingWidget_t, stringdata) + ofs \
...
const QMetaObject QmitkImageMaskingWidget::staticMetaObject = {
    { &QmitkSegmentationUtilityWidget::staticMetaObject, qt_meta_stringdata_QmitkImageMaskingWidget.data,
      qt_meta_data_QmitkImageMaskingWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QmitkImageMaskingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QmitkImageMaskingWidget.stringdata))
        return static_cast<void*>(const_cast< QmitkImageMaskingWidget*>(this));
