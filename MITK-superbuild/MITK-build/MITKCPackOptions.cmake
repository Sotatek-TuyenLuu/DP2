...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_PACKAGE_ICON "E:/D/MITK\\mitk.bmp")
  # set the install/unistall icon used for the installer itself
  # There is a bug in NSIS that does not handle full unix paths properly. 
  set(CPACK_NSIS_MUI_ICON "E:/D/MITK\\mitk.ico")
  set(CPACK_NSIS_MUI_UNIICON "E:/D/MITK\\mitk.ico")
  ...
  set(CPACK_PACKAGE_EXECUTABLES "MitkWorkbench;MITK Workbench")
     
  # tell cpack to create a desktop link to MainApp
  set(CPACK_CREATE_DESKTOP_LINKS "MitkWorkbench")
